...
import ImgArrowDown from '../../assets/icons/arrow-down-red.svg';
        ...
        {!showModal ? (
          <button type="button" onClick={() => setShowModal(true)}>
            <div className="container-arrow">
              <img className="img-arrow" src={ImgArrowDown} alt="" />
            </div>
          </button>
        ) : (
          <Modal>
            ...
            <button type="button" onClick={() => setShowModal(false)}>
              <div className="container-arrow">
                <img className="img-arrow" src={ImgArrowUp} alt="" />
              </div>
            </button>
          </Modal>
        )}
...
const Wrapper = styled.div`
  ...
  h6 {
    font: bold min(32px, 2vw) / 120% Brandon Grotesque;
    color: #24282a;
  }
